"""
Rozliczenie Tauron — sierpień 2025 (01/08/2025–31/08/2025).

Uruchomienie:
    source venv/bin/activate
    python scripts/add_tauron_rozliczenie_2025_08.py
"""
...
ROZLICZENIE_HEADER = {
    'tytul': 'Rozliczenie 08.2025',
    'okres': '01/08/2025 - 31/08/2025',
    'grupa_taryfowa': 'G12W',
    'moc_umowna_kw': 14,
    'nazwa_cennika': 'EE_GD MIX Eko_NowaEnergiaMix TS_9_Q1_01.03.25-28.02.34',
}

# Rozliczenie ilości kWh: faktura 27, prognoza 0, rozliczenie prognoz +27
KWH_POBIOR_SZCZYT = 5.0
KWH_POBIOR_POZASZCZYT = 22.0
KWH_POBIOR_TOTAL = 27.0
KWH_ODDANIE_TOTAL = 638.0

BILL_SUMMARY = {
    'wartosc_netto_zl': 52.74,
    'vat_zl': 12.13,
    'wartosc_brutto_zl': 64.87,
    'srednia_cena_brutto_zl_kwh': 2.40,
    'energia_netto_zl': 31.12,
    'energia_brutto_zl': 38.28,
    'dystrybucja_netto_zl': 21.62,
    'dystrybucja_brutto_zl': 26.59,
}
...
TAURON_TARIFF = {
    ...
    'notes': (
        ...
        'Prognoza 0 kWh, rozliczenie 27 kWh.'
    ),
}
...
TAURON_BILL = {
    ...
    'bill_number': 'rozliczenie_08.2025_2025-08-01_31',
...
def _replace_prior(conn: sqlite3.Connection) -> None:
    ...
    conn.execute(
        "DELETE FROM tauron_tariff WHERE valid_from = ? AND notes LIKE '%Rozliczenie 08.2025%'",
        ('2025-08-01',),
    )
    conn.commit()
...
def main():
    ...
    print('\n   Rozliczenie prognoz: faktura 27 kWh, prognoza 0 kWh → +27 kWh')

    print('\n📌 vs blankiet prognozy T/K1/0411004/25/3 (07–08/2025):')
    print('   Blankiet (2 mies.): 1034 kWh, brutto 1008,77 zł')
    print('   Lip + sie rzeczywiste: 12 + 27 = 39 kWh pobór, 53,21 + 64,87 = 118,08 zł brutto')
